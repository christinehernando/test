...
const addModuleImportToRootModule = (host, moduleName, src, project) => {
    ...
    exports.addModuleImportToModule(host, modulePath, moduleName, src);
};
exports.addModuleImportToRootModule = addModuleImportToRootModule;
const addModuleImportToModule = (host, modulePath, moduleName, src) => {
    const moduleSource = exports.getSourceFile(host, modulePath);
    if (!moduleSource) {
...
const getWorkspace = (host) => {
    const path = exports.getWorkspacePath(host);
