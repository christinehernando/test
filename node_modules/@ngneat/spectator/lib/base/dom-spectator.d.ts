import { DebugElement, Type, EventEmitter } from '@angular/core';
...
export declare abstract class DomSpectator<I> extends BaseSpectator {
    ...
    dispatchMouseEvent(selector: SpectatorElement | undefined, type: string, x?: number, y?: number, event?: MouseEvent): MouseEvent;
    ...
    dispatchFakeEvent(selector: SpectatorElement | undefined, type: string, canBubble?: boolean): Event;
    triggerEventHandler<C = any, K extends KeysMatching<C, EventEmitter<any>> = any>(directiveOrSelector: Type<C> | string | DebugElement, eventName: K, eventObj: EventEmitterType<C[K]>, options?: {
        root: boolean;
    }): void;
    get keyboard(): {
    ...
    dispatchTouchEvent(selector: SpectatorElement | undefined, type: string, x?: number, y?: number): void;
    typeInElement(value: string, selector?: SpectatorElement): void;
    selectOption(selector: SpectatorElement | undefined, options: string | string[] | HTMLOptionElement | HTMLOptionElement[], config?: {
        emitEvents: boolean;
    }): void;
    private getNativeElement;
    private getTriggerDebugElement;
    private getRootDebugElement;
}
