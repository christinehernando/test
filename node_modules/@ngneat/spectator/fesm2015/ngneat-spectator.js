import { SimpleChange, ChangeDetectorRef, DebugElement, ElementRef, NO_ERRORS_SCHEMA, Component, NgModule, Directive, Input, HostListener, NgZone } from '@angular/core';
 ...
 */
const toBePartial = comparator(ɵ21);
/**
 ...
 *
 */
const toBeHidden = comparator(ɵ22);
const ɵ23 = (el) => {
 ...
 *
 */
const toBeSelected = comparator(ɵ23);
const ɵ24 = (el) => {
    const pass = !isHidden(el);
 ...
 *
 */
const toBeVisible = comparator(ɵ24);
const ɵ25 = (el) => {
 ...
 */
const toBeFocused = comparator(ɵ25);
 ...
 */
const toBeMatchedBy = comparator(ɵ26);
 ...
 */
const toHaveDescendant = comparator(ɵ27);
 ...
 */
const toHaveDescendantWithText = comparator(ɵ28);
...
const toHaveSelectedOptions = comparator(ɵ29);
